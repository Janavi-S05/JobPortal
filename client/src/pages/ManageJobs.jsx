...
const ManageJobs = () => {
  ...
  // Function to fetch company jo applications data
  ...
  return jobs ? jobs.length === 0 ? (
    ...
    <div className='container p-4 max-w-5xl'>
      ...
      <div className='mt-4 flex justify-end'>
        <button onClick={() => navigate('/dashboard/add-job')} className='bg-teal-600 text-white py-2 px-4 rounded'>Add new job</button>
      </div>
    </div>
  ) : <Loading />
}
